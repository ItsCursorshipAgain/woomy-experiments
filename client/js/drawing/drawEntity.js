...
let drawEntity = (function() {
        ...
        if (sides instanceof ImageBitmap) {
            ...
            if (!sides[2]) {
                ...
                for (let [x, y] of sides) {
                    context.lineTo(
                        centerX + radius * (x * xDirection - y * yDirection),
                        centerY + radius * (y * xDirection + x * yDirection),
                    );
                }
                context.closePath();
                context.stroke();
            ...
            case 103:
                for (let i = 0; i < 360; i++) {
                    ...
                    if (i === 135) {
                        ...
                        x =
                            centerX +
                            radius * Math.cos(((i + 90) / 360) * 2 * Math.PI + angle);
                        y =
                            centerY +
                            radius * Math.sin(((i + 90) / 360) * 2 * Math.PI + angle);
                    }
                    context.lineTo(x, y);
                }
                break;
                ...
                if (sides < 0) {
                    ...
                    for (let i = 0; i < 16; i++) {
                        let theta = (i / 16) * 2 * Math.PI,
                            x = centerX + radius * Math.cos(theta + angle + 0.4),
                            y = centerY + radius * Math.sin(theta + angle + 0.4);
                        if (i === 1 || i === 5 || i === 9 || i === 13) {
                            x = centerX;
                            y = centerY;
                        }
                    ...
                    for (let i = 0; i < 12; i++) {
                        let theta = (i / 12) * 2 * Math.PI,
                            x = centerX + radius * Math.cos(theta + (angle - 0.025)),
                            y = centerY + radius * Math.sin(theta + (angle - 0.025));
                        if (i === 2 || i === 10 || i === 6) {
                            x = centerX + (radius / 2) * Math.cos(theta + (angle - 0.025));
                            y = centerY + (radius / 2) * Math.sin(theta + (angle - 0.025));
                        }
                        if (i === 0 || i === 4 || i === 8) {
                            x = centerX + radius * 1.25 * Math.cos(theta + (angle - 0.025));
                            y = centerY + radius * 1.25 * Math.sin(theta + (angle - 0.025));
                        }
                        context.lineTo(x, y);
                    }
                } else if (sides === 109) {
                    ...
                    for (let [scale, theta] of [
                        ...
                        context.lineTo(
                            centerX + radius * scale * Math.cos(angle + (theta - 0.025)),
                            centerY + radius * scale * Math.sin(angle + (theta - 0.025)),
                        );
                } else if (sides === 113) {
                    // Waller
                    for (let [scale, theta] of [
                    ...
                    for (let [scale, theta] of [
                        ...
                        context.lineTo(
                            centerX +
                            radius * (scale * 1.5) * Math.cos(angle + (theta - 0.0261)),
                            centerY +
                            radius * (scale * 1.5) * Math.sin(angle + (theta - 0.0261)),
                        );
                } else if (sides === 117) {
                    // Frigate
                    for (let [scale, theta] of [
                        ...
                        context.lineTo(
                            centerX + radius * (scale * 0.9) * Math.cos(angle + theta),
                            centerY + radius * (scale * 0.9) * Math.sin(angle + theta),
                        );
                } else if (sides === 118) {
                    // Blue Runner
                    for (let [scale, theta] of [
                    ...
                    context.arc(centerAway, centerAway, scaleRadius, 0, 0.5 * Math.PI);
                    context.arc(
                        -centerAway,
                        centerAway,
                        scaleRadius,
                    ...
                    for (let i = 0; i < realShape; i++) {
                        let theta = ((i + 1) / realShape) * 2 * Math.PI,
                            htheta = ((i + 0.5) / realShape) * 2 * Math.PI,
                            c = {
                                x: centerX + radius * dip * Math.cos(htheta + angle),
                                y: centerY + radius * dip * Math.sin(htheta + angle),
                            },
                    ...
                    for (let i = 0; i < realShape; i++) {
                        let theta = ((i + 1) / realShape) * Math.PI,
                            htheta = ((i + 0.5) / realShape) * Math.PI,
                            c = {
                                x: centerX + radius * dip * Math.cos(htheta + angle),
                                y: centerY + radius * dip * Math.sin(htheta + angle),
                            },
                    ...
                    for (let i = 0; i < 11; i++) {
                        let theta = (i / 11) * 2 * Math.PI,
                            x =
                                centerX +
                                radius * 1.5 * Math.cos(180 / 11 + theta + angle + 1.635),
                            y =
                                centerY +
                                radius * 1.5 * Math.sin(180 / 11 + theta + angle + 1.635);
                        context.lineTo(x, y);
                    }
                } else if (sides === 134) {
                    // Square (Rotated)
                    ...
                    for (let i = 0; i < realShape; i++) {
                        let theta = (i / realShape) * 2 * Math.PI,
                            x =
                                centerX +
                                radius * 1.5 * Math.cos(180 / 4 + theta + angle + 0.52),
                            y =
                                centerY +
                                radius * 1.5 * Math.sin(180 / 4 + theta + angle + 0.52);
                        context.lineTo(x, y);
                    }
                } else if (sides === 135) {
                    // Hexagon (Rotated)
                    ...
                    for (let [scale, theta] of [
                        ...
                        context.lineTo(
                            centerX +
                            radius * scale * Math.cos((theta * Math.PI) / 180 + angle),
                            centerY +
                            radius * scale * Math.sin((theta * Math.PI) / 180 + angle),
                        );
                } else if (sides === 143) {
                    // Boss Shape 2
                    for (let [scale, theta] of [
                    ...
                    for (let i = 0; i < 360; i++) {
                        ...
                        if (i === 180) {
                            ...
                            x =
                                centerX +
                                radius * Math.cos(((i + 180) / 360) * 2 * Math.PI + angle);
                            y =
                                centerY +
                                radius * Math.sin(((i + 180) / 360) * 2 * Math.PI + angle);
                        }
                        context.lineTo(x, y);
                    }
                } else if (sides === 146) {
                    ...
                    // Injector
                    context.arc(centerX, centerY, radius, 0, 2 * Math.PI, true);
                    context.arc(centerX, centerY, radius * 0.475, 0, 2 * Math.PI, false);
                    ...
                    context.arc(centerAway, -centerAway, scaleRadius, -0.5 * Math.PI, 0);
                    context.restore();
                } else if (sides === 192) { // Warfront Line
                    const matrix = context.getTransform();
                    const screenX = matrix.a * centerX + matrix.c * centerY + matrix.e;
                    const w = context.canvas.width;
                    const h = context.canvas.height;
                    context.save();
                    context.resetTransform();
                    context.globalAlpha = 0.25;
                    context.fillStyle = getColor(10); // blue
                    context.fillRect(0, 0, screenX, h);
                    context.fillStyle = getColor(12); // red
                    context.fillRect(screenX, 0, w - screenX, h);
                    context.restore();
                    context.moveTo(centerX, -h * .5);
                    ...
                    switch (sides) {
                        ...
                        case 10001:
                            if (
                                !imageCache.do_not_open_at_any_cost ||
                                !imageCache.do_not_open_at_any_cost.ready
                            )
                                break;
                            context.drawImage(
                                imageCache.do_not_open_at_any_cost,
                        ...
                        case 10018:
                            ...
                            if (
                                !imageCache["f150-0"] ||
                                !imageCache["f150-0"].ready ||
                                !imageCache["f150-1"] ||
                                !imageCache["f150-1"].ready ||
                                !imageCache["f150Flipped-0"] ||
                                !imageCache["f150Flipped-0"].ready ||
                                !imageCache["f150Flipped-1"] ||
                                !imageCache["f150Flipped-1"].ready
                            )
                                break;

                            // Manage frames
                            window.frames.f150 = window.frames.f150
                                ? window.frames.f150 + 1
                                : 1;
                        ...
                        case 10021:
                            if (
                                !imageCache.seniorpentagon ||
                                !imageCache.seniorpentagon.ready
                            )
                                break;
                            context.drawImage(
                                imageCache.seniorpentagon,
                    ...
                    switch (sides) {
                        ...
                        case 267: // ESHG-85 Rectangle
                            path = new Path2D(
                                "m-80.92146 -65.90371l0.1889801 129.73228l159.59055 -0.12598419l-0.18897247 -129.73228z",
                            );
                            radiusDiv = 70;
                            break;
                        ...
                        case 274:
                            path = new Path2D(
                                "m-56.0803 -0.3169869l56.04987 -56.04987l28.249344 28.249344l0 55.958008l-28.160105 28.160105z",
                            );
                            radiusDiv = 30;
                            break;
                        ...
                        case 286:
                            path = new Path2D(
                                "m -0.83560792,-0.16484729 -0.14934489,0.08164876 .14934489,0.08164877 V -5.16764e-4 L -0.98495281,0.08113253 -0.83560792,0.16278128 .98546956,-0.001033 Z",
                            );
                            radiusDiv = 1;
                            break;
                        ...
                        case 296: // Splitter Pentagon
                            path = new Path2D(
                                "m 14.511167,-60.497522 -30.367655,9.810771 -31.388267,10.257255 44.6861613,32.4667525 z m 10.489282,3.1781 L 8.0149208,-5.0430252 H 62.980558 L 44.020993,-31.23109 Z m -77.81127,26.391156 -0.05219,31.17690746 L -52.809271,32.32937 -9.2765285,0.70081043 Z M 8.9631848,5.9149622 25.572507,57.031737 44.020993,31.727856 62.709257,5.9149622 Z M -1.6516709,8.706523 -46.385891,41.207381 l 30.529403,9.976136 31.291111,10.109459 z",
                            );
                            radiusDiv = 72;
                            break;
                        ...
                        case 302: // Kamikaze crasher
                            path = new Path2D(
                                "M -0.5 0 L -1 0.5 L -0.5 1 L 1 0 L -0.5 -1 L -1 -0.5 L -0.5 00",
                            );
                            break;
                        case 303: // RTX Body
                            path = new Path2D(
                        ...
                        case 305: // Oxyphenbutazone bullet
                            path = new Path2D(
                                "M -5.0002116 -8.6604533 L -5.0002116 8.6604533 L 9.9999064 0 L -5.0002116 -8.6604533 z M -2.5853719 -4.4777629 L 5.1707438 0 L -2.5853719 4.4777629 L -2.5853719 -4.4777629 z ",
                            );
                            radiusDiv = 8;
                            break;
                        case 306: // Droid's fuckahedron
                            path = new Path2D(
                                "M 1 0.85 L 1 -0.85 L 0.85 -1 L -0.85 -1 L -1 -0.85 L -1 0.85 L -0.85 1 L 0.85 1 L 1 0.85",
                            );
                            radiusDiv = 1;
                            break;
                        ...
                        case 325: // half a hexagon
                            path = new Path2D(
                                "M -0.5 -0.75 L 0.5 -0.75 L 0.9 0 L -0.9 0 L -0.5 -0.75",
                            );
                            radiusDiv = 0.9;
                            break;
                    }
    ...
    function makeGunPath(context, length, height, aspect, skin) {
        ...
        const h =
            aspect > 0 ? [height * aspect, height] : [height, -height * aspect];
        ...
        switch (skin) {
            ...
            case 1: // Flamethrower Barrel
                context.lineTo(
                    length * Math.cos(-h[0] / 3),
                    length * Math.sin(-h[0] / 3),
                );
            ...
            case 18: // Pyromancer barrel
                context.lineTo(
                    length * Math.cos(-h[0] / 10),
                    length * Math.sin(-h[0] / 10) - 1,
                );
                context.lineTo(length * 1.25, 0);
                context.lineTo(
                    length * Math.cos(h[0] / 10),
    ...
    const drawProp = (() => {
        ...
        function drawDiggerFace(context, p, rot, xx, yy, drawSize, m, source) {
            ...
            let x = size * 0.25;
            let y = size * 0.45;
            let mood = (source.render.extra[1] = lerp(
                source.render.extra[1],
                expression === 2 ? -0.5 : expression === 3 ? 0.5 : 0,
                0.2,
            ));
            let mouthdip = expression === 2 ? 3.75 : expression === 3 ? 3 : 1.75;
            let eye = size * 0.15;
            let xpadding = (0.3 * 0.25) / 0.45;
            let pointy = Math.min(Math.max(Math.sin(-rot) * 0.5, -0.32), 0.32) * y;
            let pointx =
                Math.min(Math.max(Math.cos(rot) * -0.5, -xpadding), xpadding) * x;
            ...
            if (Array.isArray(p.shape)) {
                for (let [x, y, cx1, cy1, cx2, cy2] of p.shape) {
                    drawPropPoints(
                        ...
                        Math.atan2(x, y),
                        cx1 !== undefined
                            ? [Math.hypot(cx1, cy1), Math.atan2(cx1, cy1)]
                            : undefined,
                        cx2 !== undefined
                            ? [Math.hypot(cx2, cy2), Math.atan2(cx2, cy2)]
                            : undefined,
                    );
                }
                ...
                if (p.shape > 0) {
                    ...
                    let scale =
                        p.scaleSize === true
                            ? (drawSize / m.size) * m.realSize * p.size
                            : p.size;
                ...
                let radius =
                    p.scaleSize === true
                        ? ((drawSize / m.size) * m.realSize * p.size) / path.path2dDiv
                        : p.size;
                let positionScale = (drawSize / m.size) * m.realSize;
    ...
    return function(x, y, instance, ratio, alpha) {
        ...
        if (useOffscreenCanvas) {
            ...
            currentContext.canvas.width = Math.max(
                (currentContext.canvas.height =
                    drawSize * m.position.axis + ratio * 7.5 * instance.size),
                1,
            );
            ...
            tankDrawX =
                ...
                (drawSize * 2 * m.position.axis * m.position.middle.x * Math.cos(rot)) /
                4;
            tankDrawY =
                currentContext.canvas.height / 2 -
                (drawSize * 2 * m.position.axis * m.position.middle.x * Math.sin(rot)) /
                4;
            ...
            currentContext.globalAlpha = config.glassMode ? 0.7 : 1;
        }
        ...
        let invulnTicker =
            instance.invuln && (Date.now() - instance.invuln) % 200 > 110;
        ...
        if (instance.leash) {
            ...
            currentContext.lineWidth =
                drawSize *
                0.45 *
                (instance.leash.fadeOverride !== 1
                    ? instance.leash.fadeOverride
                    : fade);
            currentContext.globalAlpha =
                0.25 *
                (instance.leash.fadeOverride !== 1
                    ? instance.leash.fadeOverride
                    : fade);
            ...
            for (let i = 0; i < instance.leash.points.length; i++) {
                ...
                if (i === instance.leash.points.length - 1) {
                    currentPoint.vel.x += (instance.leash.x - currentPoint.pos.x) * 0.75;
                    currentPoint.vel.y += (instance.leash.y - currentPoint.pos.y) * 0.75;
                }
            }
            ...
            for (let i = 0; i < instance.leash.points.length; i++) {
                const canvasX =
                    tankDrawX +
                    ratio * (instance.leash.points[i].pos.x - renderedAnchorX);
                const canvasY =
                    tankDrawY +
                    ratio * (instance.leash.points[i].pos.y - renderedAnchorY);
            ...
            for (let i = 0; i < m.turrets.length; i++) {
                ...
                if (t.layer === 0) {
                    ...
                    drawEntity(
                        ...
                        tankDrawY + len * Math.sin(ang),
                        t,
                        ratio,
                        alpha,
                        (drawSize / ratio / t.size) * t.sizeFactor,
                        (source?.turrets?.[i]?.lerpedFacing || 0) +
                        turretsObeyRot * adjustedRot,
                        turretsObeyRot,
                        currentContext,
                        source.turrets[i],
                        render,
        ...
        if (source.guns.length === m.guns.length) {
            ...
            for (let i = 0; i < m.guns.length; i++) {
                ...
                let gColor = mixColors(
                    getColor(gunBaseColor),
                    renderColor,
                    renderBlend,
                );
                if (invulnTicker) {
                    gColor = mixColors(gColor, color.vlgrey, 0.5);
                }
                ...
                currentContext.translate(
                    tankDrawX + drawSize * gx,
                    tankDrawY + drawSize * gy,
                );
        ...
        if (props.length) {
            for (let i = 0; i < props.length; i++) {
                let p = props[i];
                let pColor = mixColors(
                    getColor(p.color == -1 ? instance.color : p.color),
                    renderColor,
                    renderBlend,
                );
                if (invulnTicker) pColor = mixColors(pColor, color.vlgrey, 0.5);
        ...
        if (useOffscreenCanvas) {
            ...
            if (currentContext.canvas.width > 0 && currentContext.canvas.height > 0) {
                ...
                ctx.drawImage(
                    ...
                    Math.round(x - tankDrawX),
                    Math.round(y - tankDrawY),
                );
                ctx.restore();
            }
        }
